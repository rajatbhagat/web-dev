        ...
        <>
            <div className="row wd-row-style mt-3">
                <div className="col-1 col-xxl-1 col-xl-1 col-lg-2 col-md-2 col-sm-2">
                    <img src={window.location.origin + post.postAuthorImage} alt="profile_pic"
                         className="wd-follow-img"/>
                </div>
                <div className="col-11 col-xxl-11 col-xl-11 col-lg-10 col-md-10 col-sm-10">
                    <div className="row mb-2">
                        <div className="float-start">
                        <span><strong className="text-white">{post.postAuthor} <i
                            className="fa fa-check-circle"/></strong>
                        <small className="text-muted">{post.postHandle}</small><small
                                className="text-muted"> . {post.postTime}</small></span>
                    ...
                    <div className="row">
                        <div>
                            <div className="wd-post-author-name-style">
                                <img className="wd-home-screen-post-img"
                                     src={window.location.origin + post.postImage}/>
                                {post.postDescriptionHeading ?
                                 <>
                                     <div className="mt-2">
                                         <span
                                             className="text-white p-4 mt-2">{post.postDescriptionHeading}</span>
                                     </div>
                                     <div className="mb-2 mt-1">
                                         <span
                                             className="text-muted p-4">{post.postDescriptionContent}</span>
                                     </div>
                                 </> : null}
                            </div>
